...
class Personne(metaclass = ABCMeta):
    _count=0
    def _init_(self,code,nom,prenom,age) :
        self._code=code
        self._nom=nom
        self._prenom=prenom
        self._age=age
...
class Employe(Personne) :
    _countt=0
    def _init_(self, code, nom, prenom, age,grade):
        super()._init_(code, nom, prenom, age)
        self._grade=grade
        Employe._countt+=1
    @property
    def GetCountt(self) :
...
class  Eleve(Personne) :
    _counttt=0
    def _init_(self, code, nom, prenom, age,niveau,moyenne):
        super()._init_(code, nom, prenom, age)
        self._niveau=niveau
